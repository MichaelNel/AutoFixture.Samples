...
public class FlexibleAutoDomainDataAttribute : DataAttribute
{
    private readonly Type[] _customizationTypes;
    private Lazy<IFixture> _fixture = new(FixtureFactory.Create);

    public FlexibleAutoDomainDataAttribute(params Type[] customizationTypes)
    {
    ...
    public override IEnumerable<object[]> GetData(MethodInfo testMethod)
    {
        ...
        ApplyMethodCustomizations(_fixture);
    ...
    private void ApplyMethodCustomizations(Lazy<IFixture> fixture)
    {
        foreach (var customizationType in _customizationTypes)
        {
            var customization = (ICustomization)Activator.CreateInstance(customizationType)!;
            fixture.Value.Customize(customization);
        }
    }
